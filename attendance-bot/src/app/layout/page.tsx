...
const Example: React.FC<ExampleProps> = ({ component, studentData }) => {
  return (
    <>
      {/*
            ...
            <div className="grid grid-cols-1 items-start gap-4 lg:grid-cols-3 lg:gap-8">
              ...
              <div className="grid grid-cols-1 gap-4 lg:col-span-2">
                <section aria-labelledby="section-1-title">
                  ...
                  <div className="overflow-hidden rounded-lg bg-white shadow lg:h-[43rem]">
              ...
              <div className="grid grid-cols-1 gap-4">
                <section aria-labelledby="section-2-title">
                  ...
                  <div className="flex justify-center overflow-hidden rounded-lg bg-white shadow h-[43rem]">
                    <div className="">
                      <div className="flex items-center h-full w-full justify-center p-6">
                        <div className="max-w-xs">
                          <div className="bg-white shadow-xl rounded-lg p-3">
                            <div className="photo-wrapper w-32 h-32 mx-auto overflow-hidden rounded-full">
                              <img
                                className=""
                                src={studentData.image_data}
                            ...
                            <div className="p-2">
                              ...
                              <div className="text-center text-gray-400 text-xs font-semibold">
                                <p>College: Academy of Technology</p>
